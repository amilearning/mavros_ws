...
(cl:defmethod cl:initialize-instance :after ((m <Mavlink>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mavlink)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ros-msg:<Mavlink> is deprecated: use mavlink_ros-msg:Mavlink instead.")))
...
(cl:defmethod len-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:len-val is deprecated.  Use mavlink_ros-msg:len instead.")
  (len m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:seq-val is deprecated.  Use mavlink_ros-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'sysid-val :lambda-list '(m))
(cl:defmethod sysid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:sysid-val is deprecated.  Use mavlink_ros-msg:sysid instead.")
  (sysid m))

(cl:ensure-generic-function 'compid-val :lambda-list '(m))
(cl:defmethod compid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:compid-val is deprecated.  Use mavlink_ros-msg:compid instead.")
  (compid m))

(cl:ensure-generic-function 'msgid-val :lambda-list '(m))
(cl:defmethod msgid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:msgid-val is deprecated.  Use mavlink_ros-msg:msgid instead.")
  (msgid m))

(cl:ensure-generic-function 'fromlcm-val :lambda-list '(m))
(cl:defmethod fromlcm-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:fromlcm-val is deprecated.  Use mavlink_ros-msg:fromlcm instead.")
  (fromlcm m))

(cl:ensure-generic-function 'payload64-val :lambda-list '(m))
(cl:defmethod payload64-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ros-msg:payload64-val is deprecated.  Use mavlink_ros-msg:payload64 instead.")
  (payload64 m))
